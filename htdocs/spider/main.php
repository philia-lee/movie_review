...
<head>
   ...
   <![endif]-->
    ...
    /*  민준이가 찝은거 스타일시트 ********************************/
    .slider .ss1 {
        background: url(img/movie_image1.jpg) no-repeat center center;
        background-size: cover;
    }

    .slider .ss2 {
        background: url(img/movie_image2.jpg) no-repeat center center;
        background-size: cover;
    }

    .slider .ss3 {
        background: url(img/movie_image3.jpg) no-repeat center center;
        background-size: cover;
    }
 ...
 맞서야만 하는 상황에 놓이게 되는데…
        ...
        <div id="last">   <!--리뷰 파트-->
            ...
            <div id="re2">
                ...
                <div class="re_mov1">
                    <div class="play" id="showTrailer" data-youtube="nTM-u3C89w0">
                ...
                <div class="re_mov2">
                    <div class="play" id="showTrailer2" data-youtube="_LWH3Qka2io">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120 120" style="enable-background:new 0 0 120 120;" xml:space="preserve">
                            <circle class="st0" cx="60" cy="60.4" r="56" />
                            <path class="st1" d="M81,65.4c4.8-2.8,4.8-7.2,0-10L53.5,39.6c-4.8-2.8-8.7-0.5-8.7,5v31.7c0,5.5,3.9,7.8,8.7,5L81,65.4z" />
                        </svg>
