...
<head>
   ...
   <![endif]-->
    ...
    /*  민준이가 찝은거 스타일시트 ********************************/
    .slider .ss1 {
        background: url(img/joker_image1.jpg) no-repeat center center;
        background-size: cover;
    }

    .slider .ss2 {
        background: url(img/joker_image2.jpg) no-repeat center center;
        background-size: cover;
    }

    .slider .ss3 {
        background: url(img/joker_image3.jpg) no-repeat center center;
        background-size: cover;
    }

    .slider .ss4 {
        background: url(img/joker_image4.jpg) no-repeat center center;
        background-size: cover;
    }
    #re2 .re_mov1 {
        margin: 0 auto;
  ...
  <section id="header">
    ...
    <div id="main"> <!--가로 조정범위 11.27-->
            <div id="story">  <!--첫번째 부분-->
              ...
              <div id ="one_text">
                <span id="h3">“내 인생이 비극인줄 알았는데, 코미디였어”</span>
              </div>
                <div id="main_story">
        ...
        <div id="character">
          <div class="sub_title">
            ...
            <div class="character2">
                ...
                <img src="img/토드 필립스.jpg" class="char_img">
                <div class="ch_name">
                  감독 <br>
                  토드 필립스
                </div>
            ...
            <div class="character2">
                <img src="img/호아킨 피닉스.jpg" class="char_img">
                <div class="ch_name">
                    주연<br>
                    호아킨 피닉스
                </div>
            ...
            <div class="character2">
                <img src="img/재지 비츠.jpg" class="char_img">
                <div class="ch_name">
                    조연<br>
                    재지 비츠
                </div>
            ...
            <div class="character2">
                <img src="img/로버트 드 니로.jpg" class="char_img">
                <div class="ch_name">
                  조연<br>
                  로버트 드 니로
                </div>
            ...
            <div class="character2">
                <img src="img/프란시스 콘로이.jpg" class="char_img">
                <div class="ch_name">
                  조연<br>
                  프란시스 콘로이
                </div>
        ...
        <div id="last">   <!--리뷰 파트-->
            ...
            <div id="re2">
                ...
                <div class="re_mov1">
                    <div class="play" id="showTrailer" data-youtube="q6MGNQYMe0I">
                ...
                <div class="re_mov2">
                    <div class="play" id="showTrailer2" data-youtube="TIm-QOkb4XY">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120 120" style="enable-background:new 0 0 120 120;" xml:space="preserve">
                            <circle class="st0" cx="60" cy="60.4" r="56" />
                            <path class="st1" d="M81,65.4c4.8-2.8,4.8-7.2,0-10L53.5,39.6c-4.8-2.8-8.7-0.5-8.7,5v31.7c0,5.5,3.9,7.8,8.7,5L81,65.4z" />
                        </svg>
